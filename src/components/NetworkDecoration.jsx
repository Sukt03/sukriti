...
export default function NetworkDecoration({ position = 'right', className = '' }) {
  return <svg viewBox="0 0 105 100" aria-hidden="true" className={`node-pulse pointer-events-none absolute h-52 w-56 text-purple sm:h-64 sm:w-72 ${position === 'left' ? '-left-16 bottom-4' : '-right-14 top-12'} ${className}`}>
