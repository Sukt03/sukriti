...
export default function Experience() {
  return <section id="experience" className="section-shell relative scroll-mt-28 overflow-hidden py-10 sm:py-12"><NetworkDecoration position="right" className="top-[42%]"/><div className="relative">
