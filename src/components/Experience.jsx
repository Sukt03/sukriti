...
export default function Experience() {
  return <section id="experience" className="section-shell relative scroll-mt-28 overflow-hidden py-10 sm:py-12"><NetworkDecoration position="right" className="top-[24%]"/><NetworkDecoration position="left" className="bottom-[8%] scale-90 opacity-75"/><div className="relative">
